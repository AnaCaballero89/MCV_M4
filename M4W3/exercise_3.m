...
% show inliers
figure;
plotmatches(im1, im3, points_1(1:2,:), points_3(1:2,:), matches(:,inliers), 'Stacking', 'v');
title('Inliers');
...
idx_car_I1 = 1197;
idx_car_I2 = %373+678;% ToDo: identify the corresponding point of idx_car_I1 in image 2
idx_car_I3 = %Manual o com? 333+661;% ToDo: identify the corresponding point of idx_car_I1 in image 3
idx_car_I4 = %296+699;% ToDo: identify the corresponding point of idx_car_I1 in image 4
...
point2 =  %NO [points_2(1:2,idx_car_I2)' 1]';
